...
function DaftarSurat(props: { bacaSuratCb: (infoSurat: InfoSurat) => void }) {
  ...
  return (
    <div className="w-full flex flex-col gap-5 overflow-x-visible mx-auto ">
      <div className="w-full h-40 flex  items-center  justify-center ">
        <h1 className="font-bold text-4xl text-center">Mulai membaca!</h1>
      </div>
      <div className="ring-1 ring-slate-200 flex items-center gap-2 shadow-sm rounded-md bg-gray-50 focus-within:ring-slate-300 px-4 py-2">
        ...
        <input
          ...
          className=" bg-inherit w-full outline-none placeholder-slate-400"
          type="text"
          name=""
      ...
      <div className="w-full  overflow-visible py-9 scrollbar-none ">
        <AnimatePresence>
          {(keyword.length
            ...
            : daftarSurat
          )?.map((infoSurat: InfoSurat) => {
            return (
              <motion.div
                key={"surat#" + infoSurat.nomor}
